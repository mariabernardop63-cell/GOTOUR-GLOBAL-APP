...
const Welcome = () => {
    ...
    return (
        <>
            ...
            {/* GOOGLE OCR SEO SCROLLABLE FOOTER */}
            <footer style={{
                ...
                <h1 style={{ fontSize: '2rem', marginBottom: '16px', color: '#1a1a1a' }}>GO TOUR</h1>
                <p style={{ maxWidth: '600px', margin: '0 auto 24px', lineHeight: '1.6', color: '#555' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: '20px' }}>
                    <button onClick={() => navigateForward('/privacy-policy')} style={{ background: 'none', border: 'none', color: '#048c83', fontWeight: 'bold', cursor: 'pointer', fontSize: '14px' }}>Política de Privacidade</button>
                    <button onClick={() => navigateForward('/terms-of-service')} style={{ background: 'none', border: 'none', color: '#048c83', fontWeight: 'bold', cursor: 'pointer', fontSize: '14px' }}>Termos de Serviço</button>
                </div>
            </footer>
        </>
    );
