...
const Login = () => {
    ...
    if (!isMobile) {
        return <DesktopLogin onBack={() => navigateBack('/')} onNavigateSignup={() => navigateForward('/signup')} />;
    }
        ...
        <div className="login-page-content">
            <div className="login-glass-container fade-in-up">
                ...
                <div className="social-login-section">
                    <p>Ou continue com</p>
                    {error && <p className="error-msg" style={{ textAlign: 'center', fontSize: '12px' }}>{error}</p>}
                    <div className="social-row">
                        <button className="social-btn" aria-label="Continuar com Google" onClick={handleGoogleLogin} disabled={isLoading}>
                            <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google" />
                        </button>
                        <button className="social-btn" aria-label="Continuar com Apple" disabled={isLoading}>
                        ...
                        <button className="social-btn" aria-label="Continuar com Facebook">
